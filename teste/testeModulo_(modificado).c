...
static ssize_t dev_write(struct file *filep, const char *buffer, size_t len, loff_t *offset){
	...
	printk(KERN_INFO "EBBChar: Received %zu characters from the user\n", len);   // message eh o tamanho da mensagem a ser escrita
   	
	// testando qual a primeira letra   
	//sprintf(message, "\nMessage is: %d", message[0]);   // message esta salvando o que esta escrito mas em dec, pois esta na tabela ASC
